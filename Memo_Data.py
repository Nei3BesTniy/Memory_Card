...
class Question():
    ''' Сохраняет информацию про один вопрос'''
    ...
    def __init__(self, question=new_quest_templ, answer=new_answer_templ, wrong_answer1='', wrong_answer2='', wrong_answer3=''):
        ...
        self.wrong_answer1 = wrong_answer1  # вважаємо, що завжди вписуються 3 невірні варіанти
        self.wrong_answer2 = wrong_answer2  #
        self.wrong_answer3 = wrong_answer3  #
        self.is_active = True  # чи продовжувати задавати це запитання?
        self.attempts = 0  # скільки разів це питання задавалося
        self.correct = 0  # кількість вірних відповідей

    def got_right(self):
        ''' изменяет статистику, получивши правильный ответ '''
        self.attempts += 1
        self.correct += 1

    def got_wrong(self):
        ''' изменяет статистику, получивши не правильный ответ '''
        self.attempts += 1


class QuestionView():
    ''' связывает данные и виджеты для для отображения вопроса  '''

    def __init__(self, frm_model, question, answer, wrong_answer1, wrong_answer2, wrong_answer3):
        # конструктор получает и запоминает объєкт с данными и виджетами, соответствующие полям анкеты
        self.frm_model = frm_model  # модель анкети
    ...
    def change(self, frm_model):
        ''' обновления данных, уже связанных с интерфейсом '''
        self.frm_model = frm_model

    def show(self):
        ''' выводит на екран все данные с объекта '''
